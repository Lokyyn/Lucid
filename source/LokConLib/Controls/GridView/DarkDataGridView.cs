...
using LCL.Controls.GridView.Base;
using LCL.Theming;
using static System.Windows.Forms.DataGridView;

namespace LCL.Controls.GridView
{
    public class DarkDataGridView : UserControl, ISupportInitialize
    {
        ...
        private void _base_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            e.CellStyle.SelectionForeColor = LCL.Helper.ColorExtender.GetContrastColor(e.CellStyle.SelectionBackColor);
        }
