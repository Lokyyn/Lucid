...
namespace LCL.Forms
{
    public partial class DarkMessageBox : DarkDialog
    {
        ...
        public DarkMessageBox(string message, string title, DarkMessageBoxIcon icon, DarkDialogButton buttons, CultureInfo culture = null)
            : this()
        {
            Text = title;
            _message = message;
        ...
        public static DialogResult ShowInformation(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok, CultureInfo culture = null)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Information, buttons, culture);
        }

        public static DialogResult ShowWarning(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok, CultureInfo culture = null)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Warning, buttons, culture);
        }

        public static DialogResult ShowError(string message, string caption, DarkDialogButton buttons = DarkDialogButton.Ok, CultureInfo culture = null)
        {
            return ShowDialog(message, caption, DarkMessageBoxIcon.Error, buttons, culture);
        }

        private static DialogResult ShowDialog(string message, string caption, DarkMessageBoxIcon icon, DarkDialogButton buttons, CultureInfo culture = null)
        {
            using (var dlg = new DarkMessageBox(message, caption, icon, buttons, culture))
            {
