...
public partial class ToolWindow : LucidToolWindow
{
    public ToolWindow()
    {
        ...
        node2.BadgeCollection.AddBadge("b1", "Limited Edition", "c1");
        node2.BadgeColors.AddColor("c1", Color.Yellow, Color.Black);

        node3.BadgeCollection.AddBadge("b1", "Fast delivery", "c1");
        node3.BadgeCollection.AddBadge("b2", "Discount", "c2");
        ...
        node4.BadgeCollection.AddBadge("b1", "International free shipping", "c1");
