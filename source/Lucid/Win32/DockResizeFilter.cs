...
public class DockResizeFilter : IMessageFilter
{
    ...
    public bool PreFilterMessage(ref Message m)
    {
        ...
        if (!(m.Msg == (int)WM.MOUSEMOVE ||
              m.Msg == (int)WM.LBUTTONDOWN || m.Msg == (int)WM.LBUTTONUP || m.Msg == (int)WM.LBUTTONDBLucidK ||
              m.Msg == (int)WM.RBUTTONDOWN || m.Msg == (int)WM.RBUTTONUP || m.Msg == (int)WM.RBUTTONDBLucidK))
            return false;
