...
public class LucidScrollBar : Control
{
    #region Event Region
    ...
    private LucidScrollOrientation _scrollOrientation;
    ...
    [DefaultValue(LucidScrollOrientation.Vertical)]
    public LucidScrollOrientation ScrollOrientation
    {
    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        if (_thumbArea.Contains(e.Location) && e.Button == MouseButtons.Left)
        {
            ...
            if (_scrollOrientation == LucidScrollOrientation.Vertical)
        ...
        if (_trackArea.Contains(e.Location) && e.Button == MouseButtons.Left)
        {
            ...
            else if (_scrollOrientation == LucidScrollOrientation.Horizontal)
            {
    ...
    {
        var isVert = _scrollOrientation == LucidScrollOrientation.Vertical;
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (_scrollOrientation == LucidScrollOrientation.Horizontal)
