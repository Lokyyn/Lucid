...
public class LucidDataGridViewButtonColumn : DataGridViewButtonColumn
{
    private bool _enabled = true;

    public LucidDataGridViewButtonColumn()
    {
        CellTemplate = new LucidDataGridViewButtonCell();
...
public class LucidDataGridViewButtonCell : DataGridViewButtonCell
{
    ...
    public bool Enabled
    {
        get
        {
            return _enabled ?? (OwningColumn as LucidDataGridViewButtonColumn)?.Enabled ?? true;
        }
        set
        {
            if (value == Enabled)
