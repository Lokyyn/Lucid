...
public class LucidListView : LucidScrollView
{
    #region Event Region
    ...
    private ObservableCollection<LucidListItem> _items;
    ...
    public ObservableCollection<LucidListItem> Items
    {
        get { return _items; }
        set
        {
    ...
    public LucidListView()
    {
        Items = new ObservableCollection<LucidListItem>();
    ...
    private void Items_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
        if (e.NewItems != null)
        {
            using (var g = CreateGraphics())
            {
                ...
                foreach (LucidListItem item in e.NewItems)
                {
        ...
        if (e.OldItems != null)
        {
            foreach (LucidListItem item in e.OldItems)
                item.TextChanged -= Item_TextChanged;
    ...
    public int GetItemIndex(LucidListItem item)
    {
    ...
    private void UpdateItemSize(LucidListItem item)
    {
        using (var g = CreateGraphics())
        {
            UpdateItemSize(item, g);
    ...
    private void UpdateItemSize(LucidListItem item, Graphics g)
    {
    ...
    private void UpdateItemPosition(LucidListItem item, int index)
    {
    ...
    private void UpdateContentSize(LucidListItem item)
    {
    ...
    private IEnumerable<LucidListItem> ItemsInView()
    {
