...
[DefaultEvent("Click")]
public class LucidButton : Button
{
    #region Field Region
    ...
    [DefaultValue(LucidButtonStyle.Normal)]
    public LucidButtonStyle ButtonStyle
    {
        get { return _style; }
        set
        {
            ...
            if (_style == LucidButtonStyle.Rounded)
            {
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public LucidControlState ButtonState
    {
    ...
    public LucidButton()
    {
        ...
        SetButtonState(LucidControlState.Normal);
    ...
    private void SetButtonState(LucidControlState buttonState)
    {
    ...
    protected override void OnMouseMove(MouseEventArgs e)
    {
        ...
        if (e.Button == MouseButtons.Left)
        {
            if (ClientRectangle.Contains(e.Location))
                SetButtonState(LucidControlState.Pressed);
            else
                SetButtonState(LucidControlState.Hover);
        }
        else
        {
            SetButtonState(LucidControlState.Hover);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (Enabled)
        {
            if (ButtonStyle == LucidButtonStyle.Normal || ButtonStyle == LucidButtonStyle.Rounded)
            {
                ...
                switch (ButtonState)
                {
                    case LucidControlState.Hover:
                        fillColor = _isDefault ? ThemeProvider.Theme.Colors.BlueBackground : ThemeProvider.Theme.Colors.SurfaceDefault;
                        break;
            ...
            else if (ButtonStyle == LucidButtonStyle.Flat)
            {
                switch (ButtonState)
                {
        ...
        if (ButtonStyle != LucidButtonStyle.Rounded)
        {
        ...
        if (ButtonStyle == LucidButtonStyle.Normal)
        {
