...
public abstract class LucidScrollBase : Control
{
    #region Event Region
    ...
    protected LucidScrollBase()
    {
        SetStyle(ControlStyles.Selectable |
                 ControlStyles.UserMouse, true);

        _vScrollBar = new LucidScrollBar { ScrollOrientation = LucidScrollOrientation.Vertical };
        _hScrollBar = new LucidScrollBar { ScrollOrientation = LucidScrollOrientation.Horizontal };
    ...
    protected override void OnMouseWheel(MouseEventArgs e)
    {
        ...
        {
            if (e.Delta > 0)
                _vScrollBar.ScrollByPhysical(10);
            else if (e.Delta < 0)
                _vScrollBar.ScrollByPhysical(-10);
        }
        else
