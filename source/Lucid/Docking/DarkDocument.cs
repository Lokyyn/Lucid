...
namespace Lucid.Docking
{
    ...
    public class DarkDocument : DarkDockContent
    {
        ...
        public DarkDocument()
        {
            ...
            _vScrollBar = new DarkScrollBar { ScrollOrientation = DarkScrollOrientation.Vertical, Visible = true };
            _hScrollBar = new DarkScrollBar { ScrollOrientation = DarkScrollOrientation.Horizontal, Visible = true };
